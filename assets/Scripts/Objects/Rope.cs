...
public class Rope : MonoBehaviour {
	...
	*/
	...
	public float lowTwistLimit = -10.0F;					//  The lower limit around the primary axis of the character joint. 
	public float highTwistLimit = 10.0F;					//  The upper limit around the primary axis of the character joint.
